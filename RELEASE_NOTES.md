...
* **Bug Fix:** Fixed a crash on Android 11 (`NoSuchMethodError: removeFirst()`) in `AutoLayout.kt` by using `removeAt(0)`.
...
* **AI Connection Testing:** Fixed STT connection test logic in settings dialog to test each provider using valid provider-specific models.
...
**v2.1.3 - v2.1.7** (June 2026)

* Technical releases with minor improvements and fixes.
