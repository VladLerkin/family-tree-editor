...
actual fun Modifier.platformWheelZoom(
    ...
    var lastUpdateTime by remember { mutableStateOf(0.0) }
    ...
    pointerInput(Unit) {
        detectTransformGestures { centroid, panChange, zoomChange, _ ->
            ...
            val currentTime = NSDate().timeIntervalSince1970 * 1000.0 // Convert to milliseconds
            if (currentTime - lastUpdateTime > 300.0) {
                ...
                throttleJob = coroutineScope.launch {
                    ...
                    pendingScale?.let { scale ->
                        setScale(scale)
                        lastUpdateTime = NSDate().timeIntervalSince1970 * 1000.0
                        pendingScale = null
                    }
                }
            }
