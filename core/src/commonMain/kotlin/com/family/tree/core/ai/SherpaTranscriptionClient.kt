...
class SherpaTranscriptionClient : TranscriptionClient {
    private val manager = SherpaRecognizerManager()
    ...
    override suspend fun transcribeAudio(audioData: ByteArray, config: AiConfig): String {
        ...
        if (!manager.isModelDownloaded(lang)) {
            ...
            throw Exception("Sherpa-ONNX model for language '$lang' is not downloaded. Please download it in AI Settings first.")
        }
